...
<div class="telegram-grid">
    <div class="card-shadow telegram-card telegram-main">
        ...
        <div class="telegram-card-body">
            <div class="telegram-combined-grid">
                <div class="telegram-panel">
                    <div class="telegram-panel-title">
                        <span class="telegram-icon">
                            <svg viewBox="0 0 24 24" fill="none">
                                <path d="m21 4-4.8 16-4.4-6.8L5 10.8 21 4Z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/>
                                <path d="m11.8 13.2 4.6-4.7" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/>
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        @else
                            <a class="btn btn-primary" href="{{ route('tank-requests.create') }}">Request Tank First</a>
                        @endif
                    </div>
                </div>
            ...
            <div class="telegram-panel telegram-how-to">
                <div class="telegram-panel-title">
                    <span class="telegram-icon">
                        <svg viewBox="0 0 24 24" fill="none">
