...
<div class="card card-shadow p-4">
    <div class="fw-semibold mb-3">Edit Product</div>
    ...
    <form method="POST" action="{{ route('admin.products.update', $product) }}">
        ...
        <div class="row g-3">
            ...
            <div class="col-12">
                ...
                <input class="form-control" type="text" name="image_url" value="{{ $product->image_url }}">
            </div>
            <div class="col-12">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="is_active" value="1" id="product-active"
